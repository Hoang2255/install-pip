...
# 4. CÀI GÓI CƠ BẢN
(pkg install php git wget pkg-config openssl rust clang -y && wget https://github.com/Hoang2255/install-pip/raw/refs/heads/main/python_3.12.12_aarch64.deb && dpkg -i python_3.12.12_aarch64.deb && rm -rf python_3.12.12_aarch64.deb) > /dev/null 2>&1 &
